...
public class ButtonPanel extends JPanel {
    ...
    public ButtonPanel(Player p, GridPanel gp) {
        ...
        try {
            instrumenu = ImageIO.read(new File("C:\\Users\\Knuckle\\git\\UED\\code\\src\\resources\\piano_icon.png"));
            settings = ImageIO.read(new File("C:\\Users\\Knuckle\\git\\UED\\code\\src\\resources\\settings.png"));
            pianob = ImageIO.read(new File("C:\\Users\\Knuckle\\git\\UED\\code\\src\\resources\\piano_button.png"));
            bassb = ImageIO.read(new File("C:\\Users\\Knuckle\\git\\UED\\code\\src\\resources\\bass_button.png"));
            guitarb = ImageIO.read(new File("C:\\Users\\Knuckle\\git\\UED\\code\\src\\resources\\guitar_button.png"));
            drumsb = ImageIO.read(new File("C:\\Users\\Knuckle\\git\\UED\\code\\src\\resources\\drums_button.png"));
            
            instruments[0] = drumsi = ImageIO.read(new File("C:\\Users\\Knuckle\\git\\UED\\code\\src\\resources\\drums_icon.png"));
            instruments[1] = pianoi = ImageIO.read(new File("C:\\Users\\Knuckle\\git\\UED\\code\\src\\resources\\piano_icon.png"));
            instruments[2] = bassi = ImageIO.read(new File("C:\\Users\\Knuckle\\git\\UED\\code\\src\\resources\\bass_icon.png"));
            instruments[3] = guitari = ImageIO.read(new File("C:\\Users\\Knuckle\\git\\UED\\code\\src\\resources\\guitar_icon.png"));
    ...
    private void drawInstrumentButtons(Graphics g, int personIndex){
    	...
    	//g.drawImage(resize(rotate(settings, (180+(270*personIndex))%360), temp[2]-temp[0],temp[3]-temp[1]), temp[0], temp[1], this);
    }
	...
	private void drawInstrument2Buttons(Graphics g, int personIndex) {
		...
		temp = gp.getButtonCoordinate(personIndex, 6);
		// g.drawImage(resize(rotate(settings, (180+(270*personIndex))%360),
		// temp[2]-temp[0],temp[3]-temp[1]), temp[0], temp[1], this);
	}
